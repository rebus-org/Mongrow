...
public class Migrator
{
    ...
    {
        using var _lock = new MongoDbDistributedLock(
            database: _mongoDatabase,
            lockId: _options.CollectionName,
            description: "Lock for Mongrow - ensures that migration steps are never executed concurrently",
            collectionName: _options.LockCollectionName
        );
